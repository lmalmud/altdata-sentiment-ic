'''
preprocess.py
Parses the input data and creates columsn that contain the
entire raw text and a list of relevant ticker symbols
'''
...
def extract_candidates(text: str) -> List[str]:
    ...
    Returns:
    List (str): of identified tickers
    '''
...
def valid_mentions(text: str) -> List[str]:
    '''
